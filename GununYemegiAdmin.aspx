<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="GununYemegiAdmin.aspx.cs" Inherits="Yemek_Tarifleri_Sitemiz.GununYemegiAdmin" %>
                ...
                <table class="auto-style1">
                    <tr>
                        ...
                        <td class="auto-style7">
                            <a href="YemekDuzenle.aspx?Yemekid=<%#Eval("Yemekid")%>"> <asp:Image ID="Image2" runat="server" Height="30px" ImageUrl="~/Resimler/select.png" Width="30px"/></a>
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
